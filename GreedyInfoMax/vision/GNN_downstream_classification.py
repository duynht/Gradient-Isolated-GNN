...
from GreedyInfoMax.vision.models import load_vision_model, SmallModel, VisionGNN
...
if __name__ == "__main__":
    ...
    classification_model = VisionGNN.VisionGNN(
        input_dim=1024,
        hidden_dim=64,
        output_dim=10
    )
    ...
    optimizer = optim.Adam(params=classification_model.parameters(), lr=0.003)
